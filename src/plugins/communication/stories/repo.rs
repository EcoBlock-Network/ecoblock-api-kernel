...
pub async fn insert_story(pool: &PgPool, title: &str, media_url: &str, caption: &str, is_active: bool, expires_at: Option<chrono::DateTime<chrono::Utc>>, created_by: &str) -> Result<StoryDto, AppError> {
...
#[allow(dead_code)]
pub async fn list_stories(pool: &PgPool, where_sql: &str, per_page: i64, offset: i64) -> Result<(Vec<StoryDto>, i64), AppError> {
...
pub async fn update_story(pool: &PgPool, id: Uuid, title: Option<String>, media_url: Option<String>, caption: Option<String>, is_active: Option<bool>, expires_at: Option<chrono::DateTime<chrono::Utc>>) -> Result<StoryDto, AppError> {
